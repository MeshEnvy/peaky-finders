...
from peaky_finders.serve_events import reset_serve_event_hub_for_tests
from peaky_finders.serve_viewshed_jobs import reset_viewshed_warm_jobs_for_tests, warm_site_viewshed
from peaky_finders.serve_viewshed_sim import ViewshedSimOverrides
...
def test_warm_supersedes_stale_site_job(
    ...
    monkeypatch.setattr(
        "peaky_finders.serve_viewshed_jobs.site_viewshed_overlay_if_ready",
    ...
    monkeypatch.setattr(
        "peaky_finders.serve_viewshed_jobs.ensure_site_viewshed_overlay",
        _slow_overlay,
    )
