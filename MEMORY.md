...
| `assets/static/project-map/` | ESM map UI: `main.js` (entry), `init.js` (map boot), `constants.js`, `geo.js`, `api-urls.js`, `viewshed-raster.js` (shared with settings); `app.css`, favicons (rust-embed) |
